  ...
  <div class="table-responsive">
	...
	<div id="payment">
		...
		<div class="">
			...
			<?php echo apply_filters( 'woocommerce_pay_order_button_html', '<input class="button alt btn btn-primary" type="submit" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" />' ); ?>
